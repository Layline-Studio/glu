...
> **Status (2026-07-06):** Phase 1 infrastructure is **built, pending deploy**: content collections, 7 guides, 12-entry glossary, /glp-1-injection-tracker landing page, printable shot tracker (PDF), schema/sitemap/llms.txt wiring, IndexNow key. **Next actions are in §6.**
