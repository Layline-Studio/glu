...
Check the **official manufacturer website** for the current program and enroll there (avoid third-party sites promising codes). Pair it with the [prior authorization](/glossary/prior-authorization) process, not instead of it — the card lowers the cost of a covered drug best of all. And keep an eye on the evolving cash-pay and pharmacy-direct options, which have been changing quickly.
