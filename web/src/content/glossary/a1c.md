...
Two reasons. First, GLP-1s were **diabetes drugs first** — their glucose-lowering effect is exactly what A1C measures, and a falling A1C is often the clearest sign the medication is working metabolically. Second, even for people taking a GLP-1 primarily for weight, an improving A1C is a meaningful **[non-scale victory](/glossary/non-scale-victory)** — evidence of better health that the bathroom scale can't show.

## Tracking it

A1C is checked periodically by your clinician (typically every 3–6 months), not something you measure daily. Because it moves slowly, it's a great **trend to log** alongside weight — watching A1C drop over successive lab draws is one of the more motivating records in treatment, and useful context for appointments. If you're also on insulin or a sulfonylurea, discuss your targets and [hypoglycemia](/glossary/hypoglycemia) risk with your prescriber, since GLP-1s lower glucose on top of those.
