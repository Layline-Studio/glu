...
A history of pancreatitis, gallstones, or heavy alcohol use raises baseline risk — all worth telling your prescriber before starting. Rapid weight loss itself also raises [gallstone](/glossary/gallstones) risk, and gallstones are themselves a pancreatitis trigger, so the concerns cluster.
