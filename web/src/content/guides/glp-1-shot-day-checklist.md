...
howto:
  ...
  steps:
    - 'Take the pen out of the fridge and check the liquid is clear and the dose is right.'
    - 'Pick this week''s injection site — a different spot from last week (abdomen, thigh, or upper arm).'
    - 'Inject following your pen''s instructions, then dispose of the needle in a sharps container.'
    - 'Log the dose, date, and injection site immediately, before leaving the room.'
    - 'Do your weekly check-in: weigh in, note side effects from the past week, and note how strong appetite suppression felt by day 6–7.'
---

Once-weekly medication sounds easy until you're standing in the kitchen on a Tuesday wondering: *did I inject last Sunday or the Sunday before? Left side or right side?* A weekly drug means your memory only gets 52 practice reps a year — which is exactly why [shot day](/glossary/shot-day) works better as a small fixed ritual than as 52 individual acts of remembering.
...
**Check the pen.** Take it from the fridge and confirm two things: the liquid is clear and colorless (cloudy or particled = don't use it, call the pharmacy), and it's the dose you're supposed to be on — an easy mistake during [titration](/glossary/titration) months when two strengths may be in the fridge at once.
...
3. **Weight** — one weigh-in a week, same scale, same conditions, is enough to draw a real trend. (More is fine if the daily noise doesn't mess with your head — see [why plateaus and fluctuations aren't the same thing](/guides/glp-1-plateau).)
4. **The week in one line** — worst side effect, and whether hunger or [food noise](/glossary/food-noise) came back before the next shot. "Nausea Mon–Tue, hungry again by Friday" is a genuinely useful clinical data point about whether your dose is holding the full week.
