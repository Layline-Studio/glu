...
howto:
  ...
  steps:
    - 'Set a target of roughly 1.2–1.6 g of protein per kg of body weight per day.'
    - 'Eat protein first at every meal, before carbs or vegetables.'
    - 'Front-load protein earlier in the day, when appetite suppression is often weakest.'
    - 'Keep protein-dense small foods on hand: Greek yogurt, eggs, cottage cheese, canned fish, jerky, protein shakes.'
    - 'On no-appetite days, get protein in liquid form so you never miss it entirely.'
---

On a GLP-1, protein stops being a background nutrient and becomes the daily puzzle. Your appetite shrinks, but your body's protein *need* doesn't — and falling short is the main driver of the [muscle loss](/guides/muscle-loss-on-glp-1) that turns "lighter" into "lighter but weaker." This is the cheat sheet for winning that puzzle. (The why behind it is in the [full eating guide](/guides/what-to-eat-on-glp-1); this is the how, condensed.)
...
1. **[Protein first](/glossary/protein-first).** At every meal, eat the protein before the carbs and vegetables. Fullness now arrives early and abruptly — whatever you save for last doesn't get eaten. Strand the rice, not the chicken.
...
*Sources: [Leidy et al., "The role of protein in weight loss and maintenance"](https://pubmed.ncbi.nlm.nih.gov/25926512/) (Am J Clin Nutr 2015); [Sardeli et al.](https://pubmed.ncbi.nlm.nih.gov/29562923/) on resistance training and lean mass (Nutrients 2018).*
