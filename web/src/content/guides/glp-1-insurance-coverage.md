...
howto:
  ...
  steps:
    - 'Check whether your plan covers the specific drug and indication before the pharmacy visit.'
    - 'Have your prescriber submit a prior authorization with supporting documentation.'
    - 'Gather your own evidence: weight history, BMI, related conditions, and past weight-loss attempts.'
    - 'If denied, appeal — denials are frequently overturned with the right documentation.'
    - 'If coverage fails, use a manufacturer savings card or cash-pay option to reduce cost.'
---
...
Before anything else, find out whether your plan covers **your specific drug for your specific reason.** The distinction matters enormously because of [off-label](/glossary/off-label) rules:
...
Most GLP-1 coverage requires [prior authorization](/glossary/prior-authorization) — your prescriber justifying the drug before the plan pays. Insurers typically want some mix of:

- A **qualifying diagnosis** or **[BMI](/glossary/bmi)** threshold (often ≥30, or ≥27 with a weight-related condition).
...
- **Manufacturer [savings cards](/glossary/savings-card)** can substantially lower the cost of a brand drug for people with eligible commercial insurance (note: government plans like Medicare/Medicaid are usually excluded).
...
- Weigh the risks before turning to [compounded versions](/glossary/compounded-semaglutide), which are cheaper but not FDA-approved.
...
*Sources: manufacturer coverage and savings resources (Novo Nordisk, Eli Lilly official sites); [KFF analysis of GLP-1 insurance coverage](https://www.kff.org/); plan-specific formularies. Coverage rules change frequently — verify current terms with your insurer.*
