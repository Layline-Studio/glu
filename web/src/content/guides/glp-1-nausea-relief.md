...
howto:
  ...
  steps:
    - 'Eat smaller meals, and stop at the first signal of fullness instead of finishing the plate.'
    - 'Keep meals low in fat and grease, especially in the 48 hours after your injection.'
    - 'Stay upright for 30–60 minutes after eating; late heavy dinners are the classic trigger.'
    - 'Sip fluids through the day instead of drinking large amounts with meals.'
    - 'Try ginger or peppermint tea for mild queasiness; ask your prescriber about anti-nausea medication if it persists.'
    - 'Log when nausea happens relative to your shot and dose changes, and bring the pattern to your next appointment.'
---
...
1. **Slower stomach emptying.** GLP-1 delays gastric emptying, so food sits longer. A meal size that was normal before can now sit like a stone — the nausea is often your old portion size colliding with your new stomach speed.
2. **Central effects.** GLP-1 receptors also live in brain regions involved in nausea signaling — the same pathways that make you feel queasy from other causes. This is part of the appetite mechanism itself, which is why nausea and appetite suppression tend to arrive together.
...
- **Don't inject on a huge meal day** if you can help it — many people deliberately keep [shot day](/glossary/shot-day) and the day after light and bland.
...
*Sources: [STEP 1 trial](https://www.nejm.org/doi/full/10.1056/NEJMoa2032183) (Wilding et al., NEJM 2021, adverse-event tables); [SURMOUNT-1 trial](https://www.nejm.org/doi/full/10.1056/NEJMoa2206038) (Jastreboff et al., NEJM 2022); Wegovy and Zepbound prescribing information (warnings and GI adverse reactions).*
